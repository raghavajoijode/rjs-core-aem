...
import org.subra.aem.rjs.core.commons.beans.Paging;
...
public final class PagingBuilder {
    ...
    public static Paging build(final int page, final int size, final int records, final int shown, final String ellipses) {
